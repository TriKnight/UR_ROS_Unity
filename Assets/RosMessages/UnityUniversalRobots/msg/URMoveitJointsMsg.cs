...
{
    [Serializable]
    public class URMoveitJointsMsg : Message
    {
        public const string k_RosMessageName = "unity_universal_robots/URMoveitJoints";
        ...
        public URMoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static URMoveitJointsMsg Deserialize(MessageDeserializer deserializer) => new URMoveitJointsMsg(deserializer);

        private URMoveitJointsMsg(MessageDeserializer deserializer)
        {
